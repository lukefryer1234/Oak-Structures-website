...
import { ShoppingCart, FileText, Settings, Users, Truck, GalleryHorizontal as ImageIconLucide } from 'lucide-react'; // Renamed GalleryHorizontal to avoid conflict
...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Test Hello Button */}
      <div className="my-4">
        <Button variant="outline">Hello Button Test</Button>
      </div>
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
           <Button variant="outline" asChild className="justify-start gap-2">
               <Link href="/admin/products/main-product-prices"><Settings className="h-4 w-4" /> Manage Main Product Prices</Link>
           </Button>
           <Button variant="outline" asChild className="justify-start gap-2">
                <Link href="/admin/content/gallery"><ImageIconLucide className="h-4 w-4" /> Update Gallery</Link>
           </Button>
           <Button variant="outline" asChild className="justify-start gap-2">
