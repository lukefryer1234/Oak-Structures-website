  ...
  return [
    {
      ...
      type: "background",
      target: "home",
      url: "/images/backgrounds/home-bg.jpg",
      altText: "Homepage Background Image",
      opacity: 5,
    },
    {
      id: "img8",
      ...
      altText: "About Page Background Image",
      opacity: 5,
    },
    {
      id: "bg-admin",
      type: "background",
      target: "admin",
      url: "/images/backgrounds/admin-bg.jpg",
      altText: "Admin Area Background",
      opacity: 5,
    },
    {
      id: "bg-login",
    ...
    },
    {
      ...
      type: "background",
      target: "basket",
      url: "/images/backgrounds/basket-bg.jpg",
      altText: "Basket Background",
      opacity: 5,
    },
    {
      id: "bg-checkout",
      type: "background",
      target: "checkout",
      url: "/images/backgrounds/checkout-bg.jpg",
      altText: "Checkout Background",
      opacity: 5,
    },
    {
      id: "bg-confirmation",
      ...
      url: "/images/backgrounds/confirmation-bg.jpg",
      altText: "Order Confirmation Background",
      opacity: 3,
    },
    {
      id: "bg-contact",
    ...
    },
    {
      ...
      type: "background",
      target: "custom-order",
      url: "/images/backgrounds/custom-order-bg.jpg",
      altText: "Custom Order Background",
      opacity: 5,
    },
    {
      id: "bg-delivery",
      type: "background",
      target: "delivery",
      url: "/images/backgrounds/delivery-bg.jpg",
      altText: "Delivery Background",
      opacity: 5,
    },
    {
      id: "bg-faq",
    ...
    },
    {
      ...
      type: "background",
      target: "privacy",
      url: "/images/backgrounds/privacy-bg.jpg",
      altText: "Privacy Background",
      opacity: 5,
    },
    {
      id: "bg-terms",
      type: "background",
      target: "terms",
      url: "/images/backgrounds/terms-bg.jpg",
    ...
    },
    {
      ...
      type: "background",
      target: "account",
      url: "/images/backgrounds/account-bg.jpg",
      altText: "Account Background",
      opacity: 5,
    },
    {
      id: "bg-products",
      type: "background",
      target: "products",
      url: "/images/backgrounds/products-bg.jpg",
      altText: "Products Background",
      opacity: 5,
    },
    {
      id: "bg-special-deals",
      ...
      url: "/images/backgrounds/special-deals-bg.jpg",
      altText: "Special Deals Background",
      opacity: 5,
    },
  ];
};
...
export function BackgroundImage({ children }: { children: React.ReactNode }) {
  ...
  const [backgroundImage, setBackgroundImage] = useState<ProductImage | null>(
    null,
  );
