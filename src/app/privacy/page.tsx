...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Timberline Commerce collects, uses, and protects your personal data when you use our website and services.",
};
...
const companyInfo = {
  ...
  phone: "01234 567 890",
  address: "12 Timber Yard, Forest Industrial Estate, Bristol, BS1 1AD", // Added address
};
  ...
  return (
    ...
    <div>
      <div className="container mx-auto px-4 py-12 md:py-16">
        {/* Use prose for readable text formatting */}
        <div className="max-w-3xl mx-auto prose prose-lg lg:prose-xl text-foreground prose-headings:text-foreground prose-headings:font-semibold prose-headings:mt-8 prose-headings:mb-4 prose-a:text-primary hover:prose-a:text-primary/80 prose-strong:text-foreground prose-ul:list-disc prose-ul:pl-6 prose-li:my-1 prose-p:leading-relaxed prose-p:mb-4">
          ...
          <p>
            Timberline Commerce ("us", "we", or "our") operates the [Your
            Website URL - Replace Me] website (the "Service").
          </p>
          <p>
          ...
          <p>
            We use your data to provide and improve the Service, process your
            orders, and communicate with you. By using the Service, you agree to
          ...
          <h4>Personal Data</h4>
          <p>
            While using our Service, particularly during registration, checkout,
            or when submitting inquiries, we may ask you to provide us with
            certain personally identifiable information ("Personal Data"). This
          ...
          <ul>
            ...
            <li>Order history</li>
            <li>
              Communication records (e.g., custom order inquiries, support
              requests)
            </li>
          ...
          <h4>Usage Data</h4>
          <p>
            We may automatically collect information on how the Service is
            ...
            pages, unique device identifiers, and other diagnostic data. We use
            this data to analyze trends, administer the site, track users'
            movements around the site, and gather demographic information about
            our user base as a whole.
          </p>
          <h4>Tracking & Cookies Data</h4>
          <p>
            We use cookies and similar tracking technologies (like web beacons
            and pixels) to track the activity on our Service, hold certain
            information, and improve your user experience. Cookies are files
            with a small amount of data which may include an anonymous unique
            identifier. Examples of Cookies we use:
          </p>
          <ul>
            <li>
              <strong>Session Cookies:</strong> We use Session Cookies to
              operate our Service (e.g., keeping you logged in, maintaining your
              shopping basket).
            </li>
            <li>
            ...
            <li>
              <strong>Analytics Cookies:</strong> We may use third-party Service
              Providers (like Google Analytics) to monitor and analyze the use
              of our Service.
            </li>
          </ul>
          <p>
            ...
            you may not be able to use some portions of our Service effectively.
          </p>

          <h2>2. Use of Data</h2>
          <p>
            Timberline Commerce uses the collected data for purposes including:
          </p>
          <ul>
            ...
            <li>
              To monitor the usage of the Service and prevent fraudulent
              activity
            </li>
          ...
          <ul>
            <li>
              ...
              perform a contract with you (e.g., to process and deliver your
              order).
            </li>
            <li>
              <strong>Consent:</strong> You have given us explicit permission to
              process your data for a specific purpose (e.g., signing up for a
              newsletter - if applicable).
            </li>
            <li>
              <strong>Legitimate Interests:</strong> Processing is necessary for
              our legitimate interests (e.g., improving our service, preventing
              fraud), provided these interests are not overridden by your data
              protection rights.
            </li>
            <li>
              <strong>Legal Obligation:</strong> Processing is necessary to
              comply with the law (e.g., retaining transaction records for tax
              purposes).
            </li>
          </ul>
          ...
          <p>
            ...
            transaction data as required by law (e.g., for tax and accounting
            purposes, typically 6-7 years). Account information will be retained
            as long as your account is active or as needed to provide you
            services. Usage data is generally retained for a shorter period,
          ...
          <p>
            ...
            and maintained on — computers and servers located outside of your
            state, province, country, or other governmental jurisdiction where
            the data protection laws may differ. Our primary servers are located
            within the [Specify Location, e.g., UK/EEA]. If we transfer data
            outside the EEA, we will ensure appropriate safeguards are in place
          ...
          <ul>
            <li>
              ...
              servicing you (e.g., payment processors like Stripe/PayPal,
              delivery companies, email service providers, cloud hosting), so
            ...
            <li>
              <strong>Business Transfer:</strong> If Timberline Commerce is
              involved in a merger, acquisition or asset sale, your Personal
              Data may be transferred.
            </li>
            <li>
              <strong>Protection of Rights:</strong> To protect and defend the
              rights or property of Timberline Commerce, or to investigate
              potential wrongdoing in connection with the Service.
            </li>
          </ul>
          ...
          <p>
            ...
            submit, or access your personal information. This includes using
            secure servers, encryption (e.g., SSL/TLS), and access controls.
          ...
          <ul>
            <li>
              <strong>Payment Processors:</strong> Stripe, PayPal (Their privacy
              policies govern their data use).
            </li>
            <li>
              <strong>Analytics:</strong> Google Analytics (Data is typically
              anonymized or pseudonymized).
            </li>
            <li>
              <strong>Email Delivery:</strong> [Your Email Provider, e.g.,
              SendGrid, Mailgun]
            </li>
            <li>
              <strong>Hosting:</strong> [Your Hosting Provider, e.g., Vercel,
              AWS]
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              <strong>The right to rectification:</strong> You can request that
              we correct any information you believe is inaccurate or complete
              information you believe is incomplete (often possible via your
              account page).
            </li>
            <li>
            ...
            <li>
              <strong>The right to restrict processing:</strong> You can request
              that we restrict the processing of your personal data, under
              certain conditions.
            </li>
            <li>
              <strong>The right to object to processing:</strong> You can object
              to our processing of your personal data, under certain conditions
              (particularly for direct marketing).
            </li>
            <li>
              <strong>The right to data portability:</strong> You can request
              that we transfer the data that we have collected to another
              organization, or directly to you, under certain conditions.
            </li>
            <li>
              <strong>The right to withdraw consent:</strong> If processing is
              based on consent, you have the right to withdraw that consent at
              any time.
            </li>
          </ul>
          <p>
            To exercise any of these rights, please contact us using the details
            below. We may need to verify your identity before responding to such
            requests.
          </p>
          <p>
            You also have the right to complain to a Data Protection Authority
            (like the Information Commissioner's Office (ICO) in the UK) about
          ...
          <p>
            ...
            this page and updating the "Last updated" date. We may also inform
            you via email or a prominent notice on our Service.
          </p>
          <p>
