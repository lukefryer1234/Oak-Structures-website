          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                products, need assistance with configuration, or want to discuss
                a custom project, feel free to reach out using the details below
                or the contact form.
              </p>
            </div>
                ...
                >
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="bg-background/70 border-input"
                    />
                    {state.errors?.name && (
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="contact-subject"
                      name="subject"
                      placeholder="e.g., Question about Garages"
                      required
                      className="bg-background/70 border-input"
                    />
