...
export default function CrmDashboardPage() {
  ...
  }, [toast, setIsLoading, setSummary, setRecentLeads, setRecentContacts]); // Add state setters used by loadData to useCallback deps for clarity, though they are stable
          ...
          <div className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Latest contact form submissions and custom order requests
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
                    ...
                    <TableBody>
                      {recentContacts.map((contact) => (
                        <TableRow key={contact.id}>
                          <TableCell>
                            {contact.contactType === "Contact Form" && (
                              <Mail className="h-4 w-4 inline mr-1" />
                            )}
                            {contact.contactType === "Custom Order" && (
          ...
          <div className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage and track potential customers through your sales funnel
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
          ...
          <div className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Track customer journey from lead to purchase and beyond
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <CardContent>
                        <div className="text-2xl font-bold">
                          {isLoading ? (
                            ...
                            summary.totalLeads - summary.openInquiries
                          )}
                        </div>
                      ...
                      <CardContent>
                        <div className="text-2xl font-bold">
                          {isLoading ? (
                            ...
                            Math.round(summary.totalLeads * 0.4)
                          )}
                        </div>
                        <p className="text-xs text-muted-foreground">
                          Qualified prospects
                      ...
                      <CardContent>
                        <div className="text-2xl font-bold">
                          {isLoading ? (
                            ...
                            Math.round(summary.totalCustomers * 0.7)
                          )}
                        </div>
                        <p className="text-xs text-muted-foreground">
                          Return customers
