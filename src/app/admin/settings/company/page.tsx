  ...
  const handleSave = async () => {
    ...
    if (
      ...
      toast({
        ...
        description:
          "Please fill in all required fields (Name, Address, Email, Phone).",
      });
      return;
    }
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set your company's details displayed on the site and in
            communications.
          </CardDescription>
        </CardHeader>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Company Information</CardTitle>
        <CardDescription>
          Set your company's name, address, and contact details displayed on the
          site and in communications.
        </CardDescription>
      </CardHeader>
