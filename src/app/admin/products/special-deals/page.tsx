...
const initialDeals: SpecialDeal[] = [
  {
    ...
    description: "Our popular 2-bay garage...",
    price: 8500,
    originalPrice: 9200,
    image: "https://picsum.photos/seed/deal1/100/100",
    dataAiHint: "double oak frame garage sale",
  ...
  },
  {
    ...
    description: "Easy-to-assemble 3m x 3m kit...",
    price: 3200,
    originalPrice: 3500,
    image: "https://picsum.photos/seed/deal2/100/100",
    dataAiHint: "garden gazebo kit wood offer",
  ...
  {
    id: "deal3",
    name: "Rustic Oak Beam Bundle",
    description: "Selection of 3 reclaimed beams...",
    price: 450,
    image: "https://picsum.photos/seed/deal3/100/100",
    dataAiHint: "rustic oak beams bundle",
    href: "/special-deals/beam-bundle",
    isActive: true,
  ...
  {
    id: "deal4",
    name: "End-of-Line Oak Flooring (15m²)",
    description: "15 sq meters remaining...",
    price: 750,
    image: "https://picsum.photos/seed/deal4/100/100",
    dataAiHint: "oak flooring discount lot",
    href: "/special-deals/flooring-lot",
    isActive: false,
    isStructureType: false,
    volumeM3: 0.3,
  }, // Example inactive deal
];
...
export default function SpecialDealsPage() {
  ...
  const [formState, setFormState] = useState<Partial<SpecialDeal>>({
    isActive: true,
    isStructureType: true,
  });
  ...
  const handleSaveDeal = (event: React.FormEvent) => {
    ...
    if (
      ...
      !formState.href ||
      !formState.image ||
      !formState.dataAiHint
    ) {
      alert(
        "Please fill in all required fields (Name, Description, Price, Href, Image URL, AI Hint).",
      ); // Use toast
      return;
    }
    if (
      !formState.isStructureType &&
      (!formState.volumeM3 || formState.volumeM3 <= 0)
    ) {
      alert(
        "Please provide a valid positive Volume (m³) for Beam/Flooring type deals.",
      ); // Use toast
      return;
    }
    ...
    if (editingDeal) {
      setDeals((prev) =>
        prev.map((d) => (d.id === editingDeal.id ? newDealData : d)),
      );
    ...
    <Card>
      <CardHeader className="flex flex-row justify-between items-center">
        <div>
          ...
          <CardDescription>
            Create, edit, or remove limited-time offers and pre-configured
            items.
          </CardDescription>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[600px]">
            <DialogHeader>
              <DialogTitle>
                {editingDeal ? "Edit" : "Add"} Special Deal
              </DialogTitle>
            </DialogHeader>
            <form
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="image"
                  placeholder="https://example.com/image.jpg or /images/deal.jpg"
              ...
              <div className="space-y-2">
                <Label htmlFor="dataAiHint">
                  Image AI Hint <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="dataAiHint"
                  placeholder="e.g., double oak garage"
                  value={formState.dataAiHint ?? ""}
                  onChange={(e) =>
                    handleFormChange("dataAiHint", e.target.value)
                  }
                  required
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="href">
                  Link Href <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="href"
                  placeholder="/special-deals/your-deal-slug"
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between pt-4 border-t mt-4">
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleFormChange("isStructureType", checked)
                    }
                  />
                  <Label htmlFor="isStructureType">
                    Shipping Included? (Garage/Gazebo/Porch Type)
                  </Label>
                </div>
                <div className="space-y-2 flex-grow sm:max-w-[150px]">
                  <Label
                    htmlFor="volumeM3"
                    className={
                      formState.isStructureType ? "text-muted-foreground" : ""
                    }
                  >
                    Volume (m³) (if not included)
                  </Label>
                  <Input
                    id="volumeM3"
                    type="number"
                    ...
                    onChange={(e) =>
                      handleFormChange("volumeM3", e.target.value)
                    }
              ...
              deals.map((deal) => (
                <TableRow key={deal.id}>
                  ...
                  <TableCell className="text-center text-xs text-muted-foreground">
                    {deal.isStructureType
                      ? "Included"
                      : `Volume: ${deal.volumeM3 ?? "N/A"}m³`}
                  </TableCell>
                  <TableCell className="text-right">
                    <Button
                      variant="ghost"
