...
const initialUnitPrices: UnitPrice[] = [
  {
    id: "beams-reclaimed",
    productType: "Oak Beams",
    oakType: "Reclaimed Oak",
    unit: "per m³",
    price: 1200,
  },
  {
  ...
  {
    id: "flooring-reclaimed",
    productType: "Oak Flooring",
    oakType: "Reclaimed Oak",
    unit: "per m²",
    price: 90,
  },
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Set the base price per cubic meter (m³) for Oak Beams and per square
          meter (m²) for Oak Flooring, based on the type of oak.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Table>
