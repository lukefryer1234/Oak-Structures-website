...
const initialBasketItems: BasketItem[] = [
  {
    ...
    description:
      "Curved Truss, Reclaimed Oak, No Cat Slide, Bays: 2, Beam Size: 6x6, Bay Size: standard",
    price: 12500,
    quantity: 1,
    href: "/products/garages/configure?id=garage1",
  },
  {
    id: "flooring1",
    category: "oak-flooring",
    name: "Oak Flooring (Kilned)",
    description: "Kilned Oak Flooring: 25.00m²",
    price: 1875,
    quantity: 1,
    href: "/products/oak-flooring/configure?id=flooring1",
  },
  {
    id: "deal2",
    category: "special-deals",
    name: "Garden Gazebo Kit",
    description: "Special Deal Item",
    price: 3200,
    quantity: 1,
  ...
  },
  {
    ...
    category: "oak-beams",
    name: "Oak Beam (Green)",
    description: "Green Oak Beam: 200cm L x 15cm W x 15cm T",
    price: 36,
    quantity: 1,
