...
const addressSchema = z.object({
  ...
  postcode: z
    .string()
    .min(5, { message: "Valid UK postcode is required." })
    .max(8),
...
const checkoutSchema = z.object({
  ...
  paymentMethod: z.literal("paypal", {
    required_error: "PayPal must be selected.",
  }),
...
const orderSummary = {
  subtotal: 17575.0,
  shippingCost: 25.0, // Renamed from shipping to shippingCost
  vat: 3515.0,
  total: 21115.0,
  items: [
    // Should match OrderItem schema in actions.ts
    {
      id: "garage1",
      name: "Custom Garage (3-Bay)",
      quantity: 1,
      price: 12500,
      description: "Curved Truss, Reclaimed Oak, 2 Bays",
      category: "garages",
    },
    {
      id: "flooring1",
      name: "Oak Flooring (25m²)",
      quantity: 1,
      price: 1875,
      description: "Kilned Oak, 25m²",
...
export default function CheckoutPage() {
  ...
  async function onSubmit(values: z.infer<typeof checkoutSchema>) {
    ...
    if (!values.useBillingAsShipping && !finalShippingAddress) {
      toast({
        ...
        description: "Shipping address is required if not same as billing.",
      });
  ...
  const renderAddressFields = (
    fieldName: "billingAddress" | "shippingAddress",
  ) => (
              ...
              <Card className="bg-card/80 backdrop-blur-sm border border-border/50">
                ...
                <CardContent>
                  ...
                  <div className="mt-6 p-4 border border-border/50 rounded-md bg-muted/40 text-muted-foreground text-sm">
                    Payment gateway integration placeholder. Secure PayPal
                ...
                <CardContent>
                  <div className="rounded-md border border-border/50 p-4 bg-background/60">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Estimated delivery times vary based on product type and
                      location.
                    </p>
                  </div>
                </CardContent>
