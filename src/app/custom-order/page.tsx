...
export default function CustomOrderPage() {
  ...
  if (!currentUser) {
    ...
    if (typeof window !== "undefined") {
      ...
      return (
        // Render loading/null while redirecting
        <div>
          <div className="container mx-auto px-4 py-12 text-center flex items-center justify-center min-h-[calc(100vh-12rem)]">
            <Loader2 className="h-12 w-12 animate-spin text-primary" />
        ...
        <div className="container mx-auto px-4 py-12 text-center flex items-center justify-center min-h-[calc(100vh-12rem)]">
          <Card className="max-w-lg mx-auto bg-card/80 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>
                Please log in or register to submit a custom order inquiry.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild>
      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-3xl mx-auto bg-card/80 backdrop-blur-sm border border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              Use this form to tell us about your bespoke requirements. Provide
              as much detail as possible. Alternatively, you can contact us
              directly at{" "}
              <a
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          rows={6}
                          placeholder="Describe your project, desired dimensions, materials, features, etc."
                          {...field}
                          className="bg-background/70"
                        />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Delivery or site postcode/town"
                          {...field}
                          className="bg-background/70"
                        />
                      </FormControl>
                      <FormDescription>
                        Helps us estimate delivery if applicable.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="e.g., Within 3 months, By September 2025 (optional)"
                          {...field}
                          className="bg-background/70"
                        />
                      </FormControl>
