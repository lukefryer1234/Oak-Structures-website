              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea rows={6} placeholder="Describe your project, desired dimensions, materials, features, etc." {...field} />
                    </FormControl>
                     <FormDescription>
              ...
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Delivery or site postcode/town" {...field} />
                    </FormControl>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        <Input type="file" {...form.register("fileUpload")} />
                      </FormControl>
                      <FormDescription>
                 ...
                 <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g., £5,000 - £10,000 (optional)" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                   ...
                   <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="e.g., Within 3 months, By September 2025 (optional)" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
