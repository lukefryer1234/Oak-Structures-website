...
const formatConfigLabel = (key: string): string => {
  switch (key) {
    ...
    case "beamSize":
      return "Structural Beam Size";
    case "trussType":
      return "Truss Type";
    case "baySize":
      return "Size Per Bay";
    case "catSlide":
      return "Cat Slide Roof";
    case "legType":
      return "Leg Type";
    case "sizeType":
      return "Gazebo/Porch Size";
    case "oakType":
      return "Oak Type";
    case "dimensions":
      return "Dimensions";
...
function PreviewContent() {
  ...
  const description = Object.entries(config)
    .map(
      ([key, value]) =>
        `${formatConfigLabel(key)}: ${formatConfigValue(key, value)}`,
    )
    .join(", ");
      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-2xl mx-auto bg-card/90 backdrop-blur-sm border border-border/50 shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Review your custom configuration before proceeding.
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-2 text-sm">
              ...
              <ul className="list-disc pl-5 text-foreground space-y-1">
                {Object.entries(config).map(([key, value]) => (
                  <li key={key}>
                    <strong>{formatConfigLabel(key)}:</strong>{" "}
          ...
          <CardFooter className="justify-center pt-4">
            <Link
              href={`/products/${category}/configure?config=${configString}`}
